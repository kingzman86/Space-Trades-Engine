...
const BUYERS = [
  ...
  { name: 'Isaiah W.', location: 'Memphis, TN' },
  { name: 'Kayla J.', location: 'Baltimore, MD' },
  { name: 'Malik D.', location: 'Oakland, CA' },
  { name: 'Tiffany R.', location: 'Nashville, TN' },
  { name: 'Darius N.', location: 'Denver, CO' },
  { name: 'Latoya M.', location: 'Philadelphia, PA' },
  { name: 'Brandon E.', location: 'San Antonio, TX' },
  { name: 'Monique A.', location: 'New Orleans, LA' },
  { name: 'Tyrell G.', location: 'Jacksonville, FL' },
  { name: 'Shanice B.', location: 'Columbus, OH' },
  { name: 'Damien C.', location: 'Indianapolis, IN' },
  { name: 'Nia V.', location: 'Richmond, VA' },
  { name: 'Quincy L.', location: 'Kansas City, MO' },
  { name: 'Ebony T.', location: 'Tampa, FL' },
  { name: 'Jamal O.', location: 'St. Louis, MO' },
  { name: 'Candace H.', location: 'Raleigh, NC' },
  { name: 'Xavier P.', location: 'Minneapolis, MN' },
  { name: 'Tamara S.', location: 'Louisville, KY' },
  { name: 'Elijah R.', location: 'Portland, OR' },
  { name: 'Destiny W.', location: 'Sacramento, CA' },
  { name: 'Corey J.', location: 'Orlando, FL' },
  { name: 'Naomi F.', location: 'Austin, TX' },
  { name: 'Terrence B.', location: 'Cleveland, OH' },
  { name: 'Aaliyah K.', location: 'Boston, MA' },
  { name: 'Rodney C.', location: 'Cincinnati, OH' },
  { name: 'Imani D.', location: 'Washington, DC' },
  { name: 'DeShawn M.', location: 'Baton Rouge, LA' },
  { name: 'Keisha N.', location: 'San Diego, CA' },
  { name: 'Dominic A.', location: 'Pittsburgh, PA' },
  { name: 'Renee T.', location: 'Greensboro, NC' },
  { name: 'Kendall W.', location: 'Oklahoma City, OK' },
  { name: 'Tasha L.', location: 'Fort Worth, TX' },
  { name: 'Antoine G.', location: 'Birmingham, AL' },
  { name: 'Priya S.', location: 'San Jose, CA' },
  { name: 'Omar H.', location: 'Aurora, CO' },
  { name: 'Vanessa C.', location: 'Salt Lake City, UT' },
  { name: 'Jason B.', location: 'Tucson, AZ' },
  { name: 'Layla M.', location: 'Stockton, CA' },
];
